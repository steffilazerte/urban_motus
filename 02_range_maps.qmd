...
:::{.panel-tabset}
We'll take the species which are in the databases AND in list of approved species (see `00_setup.R`)
...
You probably only need to cite **motus** and **ebirdst** and possibly the **tidyverse**, 
but you should keep track of the packages used and their versions (under General Info).

But remember we *also* have to cite the eBird data (not just the package used below).
...
citation("ebirdst") |> print(style = "text")
