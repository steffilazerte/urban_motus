...
We will assume the following limits for `max_flight_speed` and `max_tower_dist` (defined in [Setup](XX_setup.html)).
...
We'll use a `bout_cutoff` of `r bout_cutoff` minutes defined in [Setup](XX_setup.html).
